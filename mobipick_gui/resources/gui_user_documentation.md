...
remind you of a manual step when a button starts. The reminder text and any
clipboard value come from the rules file beside the loaded button profile.
The button still starts, and reminders from several starts appear together in
